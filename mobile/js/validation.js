...
$('#submit_btn').click(function(e) {
	...
	myform.submit({
		validate: function(){
			if(!$('#fullname').val().match(nameHebPattern) && !$('#fullname').val().match(nameEngPattern) && !$('#fullname').val().match(nameRusPattern) && !$('#fullname').val().match(nameArbPattern) || $('#fullname').val() == 'שם'){
			...
			if(JET.validate.minLength($("#phone").val(), 1) || $('#phone').val() == 'טלפון'){
			...
			if(JET.validate.minLength($("#email").val(), 1) || $('#email').val() == 'מייל'){
